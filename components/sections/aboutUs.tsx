    ...
    <section id="about" className="max-w-7xl md:pt-20 pt-10 md:w-8/12 mx-auto text-blue px-4 md:px-auto">
      ...
      {roll && (
        <div className="flex flex-col gap-4 mt-4 ml-10">
          <div>
            <h2 className="text-4xl font-thin mb-4 flex gap-2">
              <span className="text-3xl color"><GiFlyingFox /></span>Notre mission
            </h2>
            <p>
          ...
          <div>
            <h2 className="text-4xl font-thin mb-4 flex gap-2">
              <span className="text-2xl color"><GiStrongMan /></span>Compétences en Génie Civil
            </h2>
            <p>
