...
export default function Contact() {
  function sendEmail(e: FormEvent<HTMLFormElement>) {
    ...
    emailjs.sendForm('service_g9r82jz', 'template_kgqbyz6', e.currentTarget)
      .then((result) => {
  ...
  return (
    <section className="absolute md:top-[70%] top-[60%] w-full">
      <section className="max-w-7xl pt-12 pb-4 md:w-6/12 w-10/12 shadow-2xl mx-auto text-white mb-20 px-4 md:px-auto bg-blue rounded-lg">
        ...
        <form className="text-blue" onSubmit={sendEmail}>
          <div>
            ...
            <div className="text-sm flex w-full justify-between gap-2 mt-4">
              <div className="w-full">
                ...
                <input type="email" name="email" className="outline-none w-full border border-gray-500 pl-2 py-2" required />
              </div>
            </div>
            <div className="text-sm flex w-full justify-between gap-2 mt-4">
              <div className="w-full">
            ...
            <div className="text-sm flex w-full justify-between gap-2 mt-4">
              <div className="w-full">
                ...
                <textarea name="message" className="rounded-b-lg outline-none w-full h-32 border border-gray-500 pl-2 py-2" required />
              </div>
            </div>
          </div>
          <div className="flex justify-center">
            <button className="w-[12rem] text-center mt-6 hover:shadow-xl p-2 rounded-xl font-bold text-xl bg-yellow text-blue">
              SOUMETTRE
            </button>
          </div>
        </form>
