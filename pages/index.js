...
export default function Home() {
  ...
  return (
    <section id="home" className="text">
     ...
     <div className="md:absolute w-full lg:-bottom-[8.5rem] md:-bottom-[12rem] flex justify-center">
        <div className="flex md:flex-row flex-col max-w-7xl md:w-7/12 background shadow p-8 gap-8">
